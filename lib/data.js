...
var users = [
    {
        ...
        password: bcryptjs_1.default.hashSync('123456', 5),
        role: 'admin',
        address: {
            fullName: 'John Doe',
            street: '111 Main St',
...
var products = [
    {
        ...
        slug: (0, utils_1.toSlug)('Nike Mens Slim-fit Long-Sleeve T-Shirt'),
        category: 'T-Shirts',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Jerzees Long-Sleeve Heavyweight Blend T-Shirt'),
        category: 'T-Shirts',
        images: [
            '/images/p12-1.jpg',
            '/images/p12-2.jpg',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Jerzees Men Long-Sleeve T-Shirt'),
        category: 'T-Shirts',
        brand: 'Jerzees',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Decrum Mens Plain Long Sleeve T-Shirt - Comfortable Soft Fashion V Neck Full Sleeves Jersey Shirts'),
        category: 'T-Shirts',
        brand: 'Jerzees',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Muscle Cmdr Men's Slim Fit Henley Shirt Long&Short Business Sleeve Casual 3 Metal Buton Placket Casual Stylish T-Shirt"),
        category: 'T-Shirts',
        brand: ' Muscle Cmdr',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Hanes Mens Long Sleeve Beefy Henley Shirt'),
        category: 'T-Shirts',
        brand: 'Jerzees',
    ...
    // Jeans
    {
        ...
        slug: (0, utils_1.toSlug)('Silver Jeans Co. Mens Jace Slim Fit Bootcut Jeans'),
        category: 'Jeans',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Levi's mens 505 Regular Fit Jeans (Also Available in Big & Tall)"),
        category: 'Jeans',
        brand: "Levi's",
        ...
        countInStock: 22,
        numSales: 54,
        description: 'A veritable classic, this 505 is made to have a comfortable look and style.',
        sizes: ['30Wx30L', '34Wx30L', '36Wx30L'],
        colors: ['Blue', 'Grey'],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Essentials Mens Straight-Fit Stretch Jean'),
        category: 'Jeans',
        brand: 'Essentials',
        ...
        countInStock: 23,
        numSales: 54,
        description: 'These classic 5-pocket straight-fit jeans are crafted with a bit of stretch for additional comfort and to help maintain their shape',
        sizes: ['30Wx30L', '34Wx30L', '36Wx30L'],
        colors: ['Grey', 'Blue'],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Buffalo David Bitton Mens Men's Driven Relaxed Denim JeansJeans"),
        category: 'Jeans',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Dickies Mens Relaxed Fit Carpenter Jean'),
        category: 'Jeans',
        brand: 'Dickies',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Wrangler mens Premium Performance Cowboy Cut Slim Fit Jean'),
        category: 'Jeans',
        brand: 'Wrangler',
        ...
        countInStock: 26,
        numSales: 48,
        description: 'Designed with a functional fit in mind, these jeans are made to stack over your favorite pair of boots. Constructed with a slim fit in the waist, seat, and thigh, this jean is made for both function and comfort for long days in the saddle.',
        sizes: ['30Wx30L', '34Wx30L', '36Wx30L'],
        colors: ['Blue', 'Grey'],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    // Watches
    {
        ...
        slug: (0, utils_1.toSlug)("Seiko Men's Analogue Watch with Black Dial"),
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('SEIKO 5 Sport SRPJ83 Beige Dial Nylon Automatic Watch, Beige, Automatic Watch'),
        category: 'Wrist Watches',
        brand: 'Seiko',
        ...
        countInStock: 32,
        numSales: 48,
        description: 'Seiko 5 Sports Collection Inspired by vintage field/aviator style: Automatic with manual winding capability',
        sizes: [],
        colors: [],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Casio Men's Heavy Duty Analog Quartz Stainless Steel Strap, Silver, 42 Casual Watch"),
        category: 'Wrist Watches',
        brand: 'Casio',
        ...
        countInStock: 33,
        numSales: 48,
        description: 'The Casio range is growing with this model  MWA-100H-1AVEF. Sporting a stainless steel case with a brushed finish, it will easily withstand all the shocks of everyday life.',
        sizes: [],
        colors: [],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Casio Classic Silver-Tone Stainless Steel Band Date Indicator Watch'),
        category: 'Wrist Watches',
        brand: 'Casio',
        ...
        countInStock: 34,
        numSales: 48,
        description: 'The new MTPVD01D-7EV is a classic 50 meter water resistant stainless steel watch now updated with a white dial. This elegant 3 hand, date display timepiece is perfect for any setting.',
        sizes: [],
        colors: [],
        vendorId: '000000000000000000000001',
        vendorName: 'Default Vendor',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Fossil Men's Grant Stainless Steel Quartz Chronograph Watch"),
        category: 'Wrist Watches',
        brand: 'Fossil',
        ...
        countInStock: 35,
        numSales: 48,
        description: 'Chronograph watch featuring silver- and blue-tone case, blue sunray dial, and silver-tone Roman numeral indices',
        sizes: [],
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Fossil Men's Machine Stainless Steel Quartz Watch"),
        category: 'Wrist Watches',
        brand: 'Fossil',
        ...
        countInStock: 36,
        numSales: 49,
        description: 'In masculine black-on-black, our industrial-inspired Machine watch will add a fresh, modern touch to your casual look. This Machine watch also features a three hand movement on a stainless steel bracelet.',
        sizes: [],
    ...
    // Sneakers
    {
        ...
        slug: (0, utils_1.toSlug)('adidas Mens Grand Court 2.0 Training Shoes Training Shoes'),
        category: 'Shoes',
        brand: 'adidas',
        ...
        countInStock: 41,
        numSales: 48,
        description: 'Cloudfoam Comfort sockliner is ultra-soft and plush, with two layers of cushioning topped with soft, breathable mesh',
        sizes: ['8', '9', '10'],
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("ziitop Men's Running Walking Shoes Fashion Sneakers Mesh Dress Shoes Business Oxfords Shoes Lightweight Casual Breathable Work Formal Shoes"),
        category: 'Shoes',
        brand: 'ziitop',
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('Skechers mens Summits High Range Hands Free Slip-in Shoes Work shoe'),
        category: 'Shoes',
        brand: 'Skechers',
        ...
        countInStock: 43,
        numSales: 72,
        description: 'Step into easy-wearing comfort with Skechers Hands Free Slip-ins™: Summits - High Range. Along with our Exclusive Heel Pillow™ holds your foot securely in place, this vegan style features a unique pop-up Skechers Slip-ins™ molded heel panel, a mesh upper with fixed laces',
        sizes: ['8', '9', '10'],
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)('DLWKIPV Mens Running Shoes Tennis Cross Training Sneakers Fashion Non Slip Outdoor Walking Jogging Shoes Mesh Light Flexible Comfortable Breathable Shoes'),
        category: 'Shoes',
        brand: 'DLWKIPV',
        ...
        countInStock: 44,
        numSales: 72,
        description: 'Design: Mesh vamp, ventilation. Sole anti-slip groove design, shock absorption and anti-slip. The inside of the shoe is wide and soft, bringing you a good comfortable experience',
        sizes: ['8', '9', '10', '11', '12'],
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("ASICS Men's GT-2000 13 Running Shoes"),
        category: 'Shoes',
        brand: 'ASICS',
        ...
        countInStock: 45,
        numSales: 64,
        description: "At least 50% of the shoe's main upper material is made with recycled content to reduce waste and carbon emissions",
        sizes: ['8', '9', '10', '11'],
    ...
    },
    {
        ...
        slug: (0, utils_1.toSlug)("Mens Wearbreeze Shoes, Urban - Ultra Comfortable Shoes, Breeze Shoes for Men, Men's Mesh Dress Sneakers Business Shoes"),
        category: 'Shoes',
        brand: 'Generic',
...
var reviews = [
    ...
    },
    {
        rating: 4,
        title: 'Pretty good',
        comment: "Solid product! Great value for the price, but there's room for minor improvements.",
    },
    {
        rating: 4,
    ...
    },
    {
        ...
        comment: 'Fantastic product! High quality, feels durable, and performs well. Highly recommend!',
    },
    {
        rating: 5,
        title: 'Perfect purchase!',
        comment: "Couldn't be happier with this product. The quality is excellent, and it works flawlessly!",
    },
    {
        rating: 5,
        title: 'Highly recommend',
        comment: "Amazing product! Worth every penny, great design, and feels premium. I'm very satisfied.",
    },
    {
        rating: 5,
        title: 'Just what I needed',
        comment: 'Exactly as described! Quality exceeded my expectations, and it arrived quickly.',
    },
    {
        rating: 5,
    ...
    },
    {
        ...
        comment: "Love this product! It's durable, stylish, and works great. Would buy again without hesitation.",
    },
];
var data = {
    users: users,
    ...
    settings: [
        {
            ...
            site: {
                name: 'NxtAmzn',
                description: 'NxtAmzn is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
            ...
            availableLanguages: i18n_config_1.i18n.locales.map(function (locale) { return ({
                code: locale.code,
                name: locale.name,
            }); }),
